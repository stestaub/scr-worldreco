module ApplicationHelper
  ...
  def faq_items
    [
        ...
        ['Was tun, wenn ich mich angemeldet habe, aber verhindert bin?', "Bitte so bald wie möglich auf dieser Webseite einloggen (#{link_to 'Login', new_participant_session_path }) und abmelden. So kann dein Platz für jemand anders freigegeben werden.".html_safe],
        ...
        ['Wo ist das Zelt?', 'Der Weltrekdordversuch findet im Zelt 2 statt. Es befindet sich an der Seestrasse zwischen dem Hotel 3 Könige und dem Pub.'.html_safe],
        ['Komme ich auf jeden Fall auf dem Rekord-Ergometer zum Einsatz?', 'Um einen unterbruchsfreien Ablauf zu erhalten, müssen wir die Zeitschlitze überbuchen. Deshalb kann es vorkommen, dass nicht alle Teilnehmer/innen eines Zeitschlitzes zum Einsatz kommen. Du erhältst aber trotzdem ein Erinnerungsgeschenk.'.html_safe],
