module ApplicationHelper
  ...
  def faq_items
    [
        ...
        ['Wie kann ich mich anmelden?', "Auf dieser Website. Einfach auf #{link_to 'Jetzt anmelden', new_registration_path } klicken. Wenn Du das Anmeldeformular ausgefüllt und abgeschickt hast, erhältst Du eine Bestätigung und deine Login-Daten per E-Mail.".html_safe],
        ...
        ['Kann ich meine Anmeldung später noch abändern?', "Ja. Rufe diese Webseite auf und klicke auf #{link_to 'Login', new_registration_path }.".html_safe],
        ['Was tun, wenn ich mich angemeldet habe, aber verhindert bin?', "Bitte so bald wie möglich auf dieser Webseite einloggen (#{link_to 'Login', new_registration_path }) und abmelden. So kann dein Platz für jemand anders frei gegeben werden.".html_safe],
