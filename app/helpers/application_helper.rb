module ApplicationHelper
  ...
  def faq_items
    [
        ...
        ['Kann ich meine Anmeldung später noch abändern?', "Ja. Rufe diese Webseite auf und klicke auf #{link_to 'Login', new_participant_path }.".html_safe],
        ['Was tun, wenn ich mich angemeldet habe, aber verhindert bin?', "Bitte so bald wie möglich auf dieser Webseite einloggen (#{link_to 'Login', new_participant_path }) und abmelden. So kann dein Platz für jemand anders frei gegeben werden.".html_safe],
